...
export type TranscriptAssetKind = 'attachment-image' | 'attachment-video' | 'attachment-audio' | 'attachment-file' | 'embed-image' | 'embed-thumbnail' | 'embed-video' | 'embed-author-icon' | 'embed-footer-icon' | 'component-image' | 'component-thumbnail' | 'component-file' | 'avatar' | 'emoji' | 'guild-icon' | 'invite-icon' | 'role-icon' | 'server-tag-badge';
